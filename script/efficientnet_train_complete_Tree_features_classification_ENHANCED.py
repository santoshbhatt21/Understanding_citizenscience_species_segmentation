...
checkpoint_path = "E:/Santosh_master_thesis/checkpoints_efficientnet_leaves_others_trunks"
...
def main():
    ...
    scheduler = torch.optim.lr_scheduler.OneCycleLR(optimizer,max_lr=1e-4,steps_per_epoch=len(train_loader),epochs=num_epochs,pct_start=0.3,anneal_strategy='cos',div_factor=25.0,final_div_factor=1e4)
