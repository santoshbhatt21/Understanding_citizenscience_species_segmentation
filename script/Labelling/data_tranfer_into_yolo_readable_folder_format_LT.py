...
# ========== CONFIG (Edit paths) ========== #
# flat 20-class images
SOURCE_IMAGES = r"E:/Santosh_master_thesis/LT_species_organ_10_species"
# sibling <class>_labels folders
SOURCE_LABELS = r"E:/Santosh_master_thesis/LT_species_organ_10_species"
TARGET_ROOT = r"E:/Santosh_master_thesis/DATA_YOLO11_strict_CAM_setting/"  # output
SPLIT_RATIO = 0.8
SEED = 42
