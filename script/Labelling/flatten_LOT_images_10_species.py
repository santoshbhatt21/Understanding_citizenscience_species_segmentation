...
# ========= EDIT THESE PATHS =========
SRC_ROOT = Path(r"E:/Santosh_master_thesis/Understanding_citizenscience_species_segmentation/Labelling_Manual")
DST_ROOT = Path(r"E:/Santosh_master_thesis/LOT_flat_10_species")                 # destination root
